...
function Contact() {
    return (
        <section id="contact" className="py-20 bg-transparent relative overflow-hidden">
            ...
            <div className="absolute top-10 right-10 w-96 h-96 bg-violet-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob"></div>
            <div className="absolute bottom-10 left-10 w-96 h-96 bg-violet-400 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000"></div>
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row justify-center items-center gap-6">
                        <motion.a
                            ...
                            className="group relative bg-gradient-to-r from-violet-500 to-violet-600 text-white font-bold py-4 px-10 rounded-full hover:shadow-glow transition-all duration-300 flex items-center gap-3 overflow-hidden"
